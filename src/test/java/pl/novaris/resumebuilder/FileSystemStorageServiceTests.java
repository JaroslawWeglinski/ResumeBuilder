...
import pl.novaris.resumebuilder.exception.StorageException;
import pl.novaris.resumebuilder.service.impl.FileSystemStorageServiceImpl;
...
public class FileSystemStorageServiceTests {
    ...
    @Before
    public void init() {
        properties.setLocation("target/storage/files/" + Math.abs(new Random().nextLong()));
